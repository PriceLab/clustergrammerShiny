...
require(['underscore', 'jquery',  'clustergrammer'], function (_, $, clustergrammer) {
    ...
    make_clust(demo3x3); // options: demo3x3, demoUSArrestsSmall (is 3x4), olc_demoUSArrests, demoUSArrests (full data set), demoBioMatrix, demoBioMatrix2, demoMicroGlial, cgStructure, matrixDemo CHANGE THIS TO CHANGE CLUSTERGRAMMER
